...
docker run -v /media:/media -v /home/touche22-aramis/working:/working aramis-imarg:latest -c -f -i /media/training-datasets/touche-task-3/touche-task-3-2022-01-21 -w /working